...
class TriadSummary:
    """Aggregate the sim-to-real triad across seeds -> the headline numbers (GAP, DA CLOSURE)."""
    ...
    def summarize(uri="sqlite:///mlflow.db"):
        ...
        stats = {arm: TriadSummary._stat(list(by[arm].values())) for arm in ARMS if by.get(arm)}
