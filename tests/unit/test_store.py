...
def test_row_defective():
    ...
    gt[0, 0] = 1
    r = store._row(_sample("hole"), {"valid": valid, "gt": gt}, "bagel_test_hole_000.npz")
...
def test_row_good_has_no_gt():
    ...
    r = store._row(_sample("good"), {"valid": valid, "gt": np.zeros((2, 2), np.uint8)}, "f.npz")
