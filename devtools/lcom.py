"""LCOM cohesion detector (qc5 Phase B / 6sc): Chidamber-Kemerer's Lack of Cohesion of Methods, the
...
(an AnomalyMethod's fit/score, a Spec's add_args/run) and a null-object stub legitimately have methods
...
survives is a CONCRETE, STATEFUL class whose behaviour genuinely splits into disjoint-state groups.

    python -m devtools.lcom core surfscan
"""
...
log = logging.getLogger("surfscan.devtools.lcom")
