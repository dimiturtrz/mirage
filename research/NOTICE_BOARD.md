...
| Current MVTec 3D-AD SOTA (landscape) | `2026-07-14_mvtec3d-ad-sota-verification.md` | **DCRDF-Net verified as published Jan-2026 (Sensors vol 26 iss 2)**: 97.1% I-AUROC / 98.8% PRO. Top 5: DCRDF-Net (97.1%), CPMF (95.15%), Shape-Guided (94.7%, 97.6% AUPRO), M3DM (94.5%, 96.4% AUPRO), AST (93.7%). Multimodal methods (RGB+depth/3D) dominate; 2023–2026 cluster. Supersedes 2026-07-06 pass. |
| Edge accelerator datasheets (primary specs) | `2026-07-15_edge_accelerator_datasheets.md` | **Confirmed**: Coral Edge TPU 4 TOPS int8 + 8 MiB SRAM. Hailo-8 26 TOPS, Hailo-8L 13 TOPS (on-die SRAM not published). RK3588 6 TOPS + ~1 MB SRAM (shared LPDDR). Jetson: Nano 67 S-TOPS, NX 100 S / 50 D TOPS, AGX 170 S / 105 DLA TOPS (shared LPDDR 8–64 GB). Pi5 no int8 TOPS (CPU), LPDDR4X 1–16 GB. |
...
- **2026-07-15**: Edge-accelerator datasheet specs pass. Primary-source TOPS + memory for all six platforms
  (Coral, Hailo-8/8L, RKNN, Jetson Orin variants, Pi5). Hailo on-die SRAM specs genuinely unpublished
  (datasheets portal-gated). Enables model-fit trade-off analysis for deploy.
